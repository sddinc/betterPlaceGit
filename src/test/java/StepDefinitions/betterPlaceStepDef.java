...
public class betterPlaceStepDef {
    WebDriver driver;
    betterPlacePage better = new betterPlacePage();

    @Given("^User should be gone to url$")
    public void userShouldBeGoneToUrl() {
        Driver.getDriver().get("https://www.bp42.com/de/donate/platform/projects/1114");
        Driver.waitAndClick(better.btnCookies,2);
    }


    @And("^User should be typed data into the form$")
    public void userShouldBeTypedDataIntoTheForm() {
    ...
    @Then("^User should be verified Donation$")
    public void userShouldBeVerifiedDonation() {
